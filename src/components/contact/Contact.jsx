      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a href="mailto:ch.calvanese@gmail.com" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp className='contact__option-icon'/>
            <h4>Whatsapp</h4>
            <h5>+56996158263</h5>
            <a href="https://api.whatsapp.com/send?phone=+56996158263" target="_blank">Send a message</a>
          </article>
        </div>
